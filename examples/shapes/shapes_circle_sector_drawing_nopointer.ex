...
--------------------------------------------------------------------------------------
    ...
    do
        ...
        BeginDrawing()
            ...
            --------------------------------------------------------------------------------
            startAngle=_GuiSliderBar({ 600, 40, 120, 20}, "StartAngle", sprintf("%.2d", startAngle), {1,startAngle}, 0, 720)
            endAngle=_GuiSliderBar({ 600, 70, 120, 20}, "EndAngle", sprintf("%.2d", endAngle), {2,endAngle}, 0, 720)

            outerRadius=_GuiSliderBar({ 600, 140, 120, 20}, "Radius", sprintf("%.2d", outerRadius), {3,outerRadius}, 0, 200)
            segments=_GuiSliderBar({ 600, 170, 120, 20}, "Segments", sprintf("%.2d", segments), {4,segments}, 0, 100)
            --------------------------------------------------------------------------------
