...
*
********************************************************************************************/
--This ported example originally comes from here: https://github.com/ghaberek/libffi-euphoria/
include "../../raylib64.e"
--include raylib.e
--include rlgl.e
--include raymath.e
...
procedure  main()
        ...
        while not WindowShouldClose() do        -- Detect window close button or ESC key
                ...
                if IsMouseButtonDown( MOUSE_BUTTON_LEFT ) then
                        ...
                        camera[2] = Vector2Add( camera[2], delta )    -- .target
                end if
                ...
                if wheel != 0 then
                        ...
                        camera[1] = GetMousePosition() -- .offset

                        -- Set the target to match, so that the camera maps the world space point 
                        -- under the cursor to the screen space point under the cursor at any zoom
                        camera[2] = mouseWorldPos -- .target
