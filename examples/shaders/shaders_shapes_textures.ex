...
--------------------------------------------------------------------------------------
    ...
    sequence shader = LoadShader(0, sprintf("resources/shaders/glsl%d/grayscale.fs", GLSL_VERSION))
    ...
    do
        ...
        BeginDrawing()
            ...
            DrawTriangle({430, 80},{430 - 60, 150},{430 + 60, 150}, VIOLET)

            DrawTriangleLines({430, 160},{430 - 20, 230},{430 + 20, 230}, DARKBLUE)

            DrawPoly({430, 320}, 6, 80, 0, BROWN)
